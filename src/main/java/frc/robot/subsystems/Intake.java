...
public class Intake extends SubsystemBase {
    private CANSparkMax subIntakeMotor = new CANSparkMax(IntakeConstants.subIntakeMotorID, MotorType.kBrushless);
    private CANSparkMax mainIntaketMotor = new CANSparkMax(IntakeConstants.mainIntakeMotorID, MotorType.kBrushless);
